...
# Combining these into one RUN command saves ~2-3 minutes of "Layer Commit" time.
...
# 3. Download Models using ARIA2 (16x Faster than curl)
# We use aria2c with -x 16 (16 connections) to maximize bandwidth.
...
# Wan 2.1 Models (CivitAI) - These are the biggest files, aria2 is mandatory here.
